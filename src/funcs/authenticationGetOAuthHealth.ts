 ...
 */
export function authenticationGetOAuthHealth(
  client: MixCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetOAuthHealthResponse,
...
> {
  const path = pathToFunc("/health/auth")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetOAuthHealthResponse$inboundSchema),
