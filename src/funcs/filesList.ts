...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListSessionFilesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/sessions/{id}/files")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, z.array(models.FileInfo$inboundSchema)),
