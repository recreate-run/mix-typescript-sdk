...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UploadSessionFileRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/sessions/{id}/files/upload")(pathParams);
  ...
  const doResult = await client._do(req, {
    context,
    errorCodes: ["400", "404", "413", "4XX", "5XX"],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, models.FileInfo$inboundSchema),
    M.jsonErr([400, 404, 413], errors.ErrorResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
