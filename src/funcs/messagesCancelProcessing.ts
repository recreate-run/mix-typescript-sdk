 ...
 */
export function messagesCancelProcessing(
  client: MixCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CancelSessionProcessingRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/sessions/{id}/cancel")(pathParams);
