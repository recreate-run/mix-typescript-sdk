 ...
 */
export function notificationsRespondToNotification(
  client: MixCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.RespondToNotificationRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/notifications/{id}/respond")(pathParams);
