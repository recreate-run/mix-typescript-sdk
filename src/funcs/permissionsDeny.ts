 ...
 */
export function permissionsDeny(
  client: MixCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.DenyPermissionRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/permissions/{id}/deny")(pathParams);
