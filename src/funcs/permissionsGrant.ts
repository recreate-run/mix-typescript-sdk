...
export function permissionsGrant(
  ...
  Result<
    operations.GrantPermissionResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GrantPermissionRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/permissions/{id}/grant")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GrantPermissionResponse$inboundSchema),
