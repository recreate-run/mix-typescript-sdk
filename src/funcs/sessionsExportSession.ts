 ...
 */
export function sessionsExportSession(
  client: MixCore,
  request: operations.ExportSessionRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ExportSessionResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ExportSessionRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/sessions/{id}/export")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ExportSessionResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
