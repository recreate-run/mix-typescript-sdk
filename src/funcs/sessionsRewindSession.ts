 ...
 */
export function sessionsRewindSession(
  client: MixCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.RewindSessionRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/sessions/{id}/rewind")(pathParams);
