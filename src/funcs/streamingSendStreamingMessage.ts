 ...
 */
export function streamingSendStreamingMessage(
  client: MixCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.SendStreamingMessageRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.MessageData, { explode: true });
  ...
  const path = pathToFunc("/stream/{id}/message")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.StreamMessageResponse$inboundSchema),
