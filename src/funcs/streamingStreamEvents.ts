 ...
 */
export function streamingStreamEvents(
  client: MixCore,
  request: operations.StreamEventsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.StreamEventsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.StreamEventsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.sse(200, operations.StreamEventsResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
