 ...
 */
export function toolsGetToolCredentialsStatus(
  client: MixCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetToolCredentialsStatusResponse,
...
> {
  const path = pathToFunc("/api/tools/credentials-status")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetToolCredentialsStatusResponse$inboundSchema),
